# SenseAR Effects SDK开发指南

本项目是**北京大甜绵白糖科技有限公司**提供的[**特效引擎 SDK**](https://sensear.softsugar.com/) HAR包，您可以集成SDK实现各类人脸特效、贴纸、美颜、滤镜等功能。
...
- 添加Xcomponent组件
  ...
  ```ts
    ...
    //注意事项：XComponent的libraryname需要与sdk so库一致，默认值为entry (libentry.so)
  ```
